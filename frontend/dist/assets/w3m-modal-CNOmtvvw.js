import{d$ as k,eB as le,cW as c,cY as pe,cI as v,cJ as V,cM as f,cN as g,cO as d,cL as l,dj as $,d5 as H,dk as u,cK as me,d1 as w,cQ as B,dh as U,es as fe,e5 as F,c_ as K,dV as A,d9 as M,cT as we,cX as E,e1 as z,ep as oe,di as be,cS as ce,eC as ge,eD as ye}from"./index-CNVB7XA4.js";import{P as D}from"./index-CwOkPaHQ.js";import{S as ve}from"./SwapController-DVSvNzqC.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
